...
import { CrawlerImportComponent } from './crawler.import.component';
...
const importResponseOk = { crawler: '/api/crawlers/1' };

const importResponseError = {
    fieldErrors: [
        {
            objectName: 'crawler',
            field: 'fetchInterval',
    ...
    public sendData(data: any, APIEndPoint: string): Observable<HttpEvent<Object>> {
        if (this.status === '422') {
            ...
            return of(new HttpResponse({
                status: 202,
                body: importResponseError
            }));
        } else {
            return of(new HttpResponse({ status: 201, body: importResponseOk }));
        }
    }
...
describe('Crawler Import Component Test - Case 1', () => {
    let component: CrawlerImportComponent;
    let fixture: ComponentFixture<CrawlerImportComponent>;
    let routerSpy;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(CrawlerImportComponent);
        component = fixture.componentInstance;
        fixture.detectChanges();
    });

    it('should create Crawler File Import form', () => {
    ...
    it('should import a valid file', waitForAsync(() => {
        ...
        const fileList = [new File([''], 'crawler.json', { type: 'application/json', lastModified: 2233 })];
...
describe('Crawler Import Component Test - Case 2', () => {
    let component: CrawlerImportComponent;
    let fixture: ComponentFixture<CrawlerImportComponent>;
    let routerSpy;
    const formBuilder: FormBuilder = new FormBuilder();
...
describe('Crawler Import Component Test - Case 3', () => {
    let component: CrawlerImportComponent;
    let fixture: ComponentFixture<CrawlerImportComponent>;
    let routerSpy;
    const formBuilder: FormBuilder = new FormBuilder();
